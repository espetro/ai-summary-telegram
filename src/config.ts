...
const configSchema = z.object({
  ...
  AI_API_URL: z.url("AI_API_URL must be a valid URL"),
  ...
  ENCRYPTION_MASTER_SECRET: z
    .string()
    .length(64, "ENCRYPTION_MASTER_SECRET must be 32 bytes (64 hex characters)"),
...
export { config, CHUNK_SIZE, CHUNK_OVERLAP, EMBEDDING_DIMENSIONS };
